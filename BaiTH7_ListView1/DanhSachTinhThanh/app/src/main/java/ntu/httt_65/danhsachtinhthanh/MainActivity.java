package ntu.httt_65.danhsachtinhthanh;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ở bài này, chúng ta làm hard-code dữ liệu trự tiếp
        ...
        //Thêm dữ liệu ở đây (đúng ra ta phải đọc từ một nguồn nhưng ta hard-code (cho sẵn để demo
    ...
    //Tạo bộ lắng nghe và xử lý sự kiện OnItemClick, đặt một biến
    //vd: BoLangNghevaXL
